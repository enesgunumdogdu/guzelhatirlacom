      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-10">
          <h1 className="font-display font-bold leading-[0.85] tracking-tight">
            <span className="block text-[clamp(4rem,15vw,10rem)] bg-gradient-to-br from-primary-500 via-primary-400 to-accent-500 bg-clip-text text-transparent bg-200% animate-gradient">
              güzel
            </span>
            <span className="block text-[clamp(4rem,15vw,10rem)] bg-gradient-to-br from-primary-500 via-primary-400 to-accent-500 bg-clip-text text-transparent bg-200% animate-gradient">
              hatırla
